...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ColorfulLibraryAccessors laccForColorfulLibraryAccessors = new ColorfulLibraryAccessors(owner);
    ...
    private final TelephotoLibraryAccessors laccForTelephotoLibraryAccessors = new TelephotoLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>colorful</b>
     */
    public ColorfulLibraryAccessors getColorful() {
        return laccForColorfulLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>telephoto</b>
     */
    public TelephotoLibraryAccessors getTelephoto() {
        return laccForTelephotoLibraryAccessors;
    }
    ...
    public static class ColorfulLibraryAccessors extends SubDependencyFactory {

        public ColorfulLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sliders</b> with <b>com.github.SmartToolFactory:Compose-Colorful-Sliders</b> coordinates and
         * with version reference <b>colorfulSliders</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSliders() {
            return create("colorful.sliders");
        }
    ...
    public static class CommonmarkExtLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>autolink</b> with <b>org.commonmark:commonmark-ext-autolink</b> coordinates and
         * with version reference <b>commonmark</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAutolink() {
            return create("commonmark.ext.autolink");
        }
    ...
    public static class TelephotoLibraryAccessors extends SubDependencyFactory {
        private final TelephotoZoomableLibraryAccessors laccForTelephotoZoomableLibraryAccessors = new TelephotoZoomableLibraryAccessors(owner);

        public TelephotoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>telephoto.zoomable</b>
         */
        public TelephotoZoomableLibraryAccessors getZoomable() {
            return laccForTelephotoZoomableLibraryAccessors;
        }

    }

    public static class TelephotoZoomableLibraryAccessors extends SubDependencyFactory {
        private final TelephotoZoomableImageLibraryAccessors laccForTelephotoZoomableImageLibraryAccessors = new TelephotoZoomableImageLibraryAccessors(owner);

        public TelephotoZoomableLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>telephoto.zoomable.image</b>
         */
        public TelephotoZoomableImageLibraryAccessors getImage() {
            return laccForTelephotoZoomableImageLibraryAccessors;
        }

    }

    public static class TelephotoZoomableImageLibraryAccessors extends SubDependencyFactory {

        public TelephotoZoomableImageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>coil</b> with <b>me.saket.telephoto:zoomable-image-coil</b> coordinates and
         * with version reference <b>telephoto</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCoil() {
            return create("telephoto.zoomable.image.coil");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>colorfulSliders</b> with value <b>1.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getColorfulSliders() { return getVersion("colorfulSliders"); }

        /**
         * Version alias <b>commonmark</b> with value <b>0.29.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>livekit</b> with value <b>2.23.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>telephoto</b> with value <b>0.14.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTelephoto() { return getVersion("telephoto"); }
